<div class="projectDesigns box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title"><?php echo __('Edit Project Design'); ?></h3>
	</div>
		...
		<div class="box-body">
			<div class="row non-margin">
				<div class="thumbnail col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<?php echo $this->Html->image('uploads/projects/designs/'.$this->data['ProjectDesign']['name'], array('alt' => $this->data['ProjectDesign']['description'])); ?>
				</div>
			</div>
			<?php
