<div class="contractorCategories box box-primary">
	...
	<tr>
		...
		<td class="actions">
			<?php //echo $this->Html->link(__('Xem'), array('action' => 'view', $contractorCategory['ContractorCategory']['id']), array('class' => 'btn btn-xs btn-info btn-flat')); ?>
			<?php echo $this->Html->link(__('Sửa'), array('action' => 'edit', $contractorCategory['ContractorCategory']['id']), array('class' => 'btn btn-xs btn-success btn-flat')); ?>
			<?php echo $this->Form->postLink(__('Xóa'), array('action' => 'delete', $contractorCategory['ContractorCategory']['id']), array('class' => 'btn btn-xs btn-danger btn-flat', 'confirm' => __('Bạn có chắc chắn muốn xóa # %s?', $contractorCategory['ContractorCategory']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
		</tbody>
