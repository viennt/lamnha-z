...
$(document).ready(function () {
	...
	actions += '<li>';
	actions += '<?php echo $this->Form->postLink("<i class=\"fa fa-circle-o text-red\"></i> <span>Delete</span>", array("action" => "delete", $this->Form->value("Group.id")), array("escape" => false), __("Are you sure you want to delete # %s?", $this->Form->value("Group.id"))); ?>';
	actions += '</li>';
