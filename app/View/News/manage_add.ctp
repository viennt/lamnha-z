...
<div class="news box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title"><?php echo __('Add News'); ?></h3>
	...
	<?php echo $this->Form->create('News', array(
		...
		<div class="box-body"><?php
			...
			echo $this->Form->input('detail', array('class'=>'form-control', 'id' => 'description-textarea'));
			echo $this->Form->input('published');
			echo $this->Form->input('user_id', array('type'=>'hidden', 'value' => $user_id));
			echo $this->Form->input('news_category_id', array('class'=>'form-control'));
		?></div>
