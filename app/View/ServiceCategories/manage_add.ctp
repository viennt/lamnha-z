<div class="serviceCategories box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title"><?php echo __('Add Service Category'); ?></h3>
	</div>
	<?php echo $this->Form->create('ServiceCategory', array(
		...
		<div class="box-body"><?php
			...
			echo $this->Form->input('parent_id', array('class'=>'form-control', 'options' => $parentServiceCategories, 'label' => 'Danh mục cha'));
		?></div>
